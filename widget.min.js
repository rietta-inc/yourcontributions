(function() {
    "use strict";
    var atags = document.getElementsByClassName("gh-contributions");
    for (var atag of atags) {
        atag.style.display = "none";
        var username = atag.dataset.ghUsername;
